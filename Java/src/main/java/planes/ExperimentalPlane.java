...
public class ExperimentalPlane extends Plane {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExperimentalPlane experimentalPlane)) {
            return false;
        }
        if (!super.equals(obj)) {
            return false;
        ...
        return experimentalType.equals(experimentalPlane.experimentalType) &&
                classificationLevel.equals(experimentalPlane.classificationLevel);
    }
