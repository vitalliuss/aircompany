...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        Airport militaryAirport = new Airport(airport.getPlanesByClass(MilitaryPlane.class));
        Airport passengerAirport = new Airport(airport.getPassengerPlanes());
        System.out.println("Military airport sorted by max distance: "
                + militaryAirport.sort(Comparator.comparingInt(Plane::getMaxFlightDistance)));
        System.out.println("Passenger airport sorted by max speed: "
                + passengerAirport.sort(Comparator.comparingInt(Plane::getMaxSpeed)));
