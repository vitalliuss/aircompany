...
public class AirportTest {
    ...
    public void testSortByMaxLoadCapacity() {
        ...
        List<Plane> expectedPlanes = new ArrayList<>(airport.getPlanes());
        expectedPlanes.sort(Comparator.comparingInt(Plane::getMaxLoadCapacity));
        Assert.assertEquals(airport.getPlanes(), expectedPlanes);
    }
    ...
    public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified() {
        Airport airport = new Airport(planes);
        Assert.assertTrue(airport.getExperimentalPlanes().stream()
